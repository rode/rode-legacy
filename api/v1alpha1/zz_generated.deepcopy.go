...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CollectorCondition) DeepCopyInto(out *CollectorCondition) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CollectorCondition.
func (in *CollectorCondition) DeepCopy() *CollectorCondition {
	if in == nil {
		return nil
	}
	out := new(CollectorCondition)
	in.DeepCopyInto(out)
	return out
}
...
func (in *CollectorStatus) DeepCopyInto(out *CollectorStatus) {
	*out = *in
	if in.Conditions != nil {
		...
		*out = make([]CollectorCondition, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
