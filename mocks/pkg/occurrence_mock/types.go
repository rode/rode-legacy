...
// Source: github.com/liatrio/rode/pkg/occurrence (interfaces: Lister,Creator)

// Package occurrence_mock is a generated GoMock package.
package occurrence_mock
...
func (m *MockLister) ListAttestations(arg0 context.Context, arg1 string) ([]*grafeas_go_proto.Occurrence, error) {
	m.ctrl.T.Helper()
...
func (mr *MockListerMockRecorder) ListAttestations(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAttestations", reflect.TypeOf((*MockLister)(nil).ListAttestations), arg0, arg1)
}

// ListOccurrences mocks base method
func (m *MockLister) ListOccurrences(arg0 context.Context, arg1 string) ([]*grafeas_go_proto.Occurrence, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListOccurrences", arg0, arg1)
	ret0, _ := ret[0].([]*grafeas_go_proto.Occurrence)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockListerMockRecorder) ListOccurrences(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListOccurrences", reflect.TypeOf((*MockLister)(nil).ListOccurrences), arg0, arg1)
}
